...
@mark.parametrize('configs', [
  ...
  [('backend', 'dynamodb'), ('dynamodb_url', 'http://localhost:8000'), ('ttl', 1)],    \
  [('backend', 'dynamodb'), ('dynamodb_url', 'http://localhost:8000'), ('ttl', 3600)], \
  ...
  [
    ('backend', 'mongodb'), ('database_name', 'fastapi-cachette-database'), \
    ('ttl', 1), ('mongodb_url', 'mongodb://localhost:27017')                \
  ],
  [
    ('backend', 'mongodb'), ('database_name', 'fastapi-cachette-database'), \
    ('ttl', 3600), ('mongodb_url', 'mongodb://localhost:27017')             \
  ],
...
@mark.parametrize('invalid_configs, reason', [
  ...
  (
    [('backend', 'dynamodb'), ('dynamodb_url', 'http://localhost:8000'), ('ttl', 0)], \
    'The "ttl" value must between 1 or 3600 seconds.'                                 \
  ),
  (
    [('backend', 'dynamodb'), ('dynamodb_url', 'http://localhost:8000'), ('ttl', 3601)], \
    'The "ttl" value must between 1 or 3600 seconds.'                                    \
  ),
  (
  ...
  (
    [('backend', 'redis'), ('ttl', 3601), ('redis_url', 'redis://localhost:6379')], \
    'The "ttl" value must between 1 or 3600 seconds.'                               \
  ),
])
