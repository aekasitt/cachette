...
@mark.parametrize('client', [
  ...
  ### DynamoDB & Codecs ###
  [('backend', 'dynamodb'), ('codec', 'csv'), ('dynamodb_url', 'http://localhost:8000')],     \
  [('backend', 'dynamodb'), ('codec', 'feather'), ('dynamodb_url', 'http://localhost:8000')], \
  [('backend', 'dynamodb'), ('codec', 'parquet'), ('dynamodb_url', 'http://localhost:8000')], \
  ...
  [('backend', 'memcached'), ('codec', 'feather'), ('memcached_host', 'localhost')], \
  [('backend', 'memcached'), ('codec', 'parquet'), ('memcached_host', 'localhost')], \
  [('backend', 'memcached'), ('codec', 'pickle'), ('memcached_host', 'localhost')],  \

  ### MongoDB & Codecs ###
  [
    ('backend', 'mongodb'), ('database_name', 'fastapi-cachette-database'), \
    ('codec', 'csv'), ('mongodb_url', 'mongodb://localhost:27017')          \
  ],
  [
    ('backend', 'mongodb'), ('database_name', 'fastapi-cachette-database'), \
    ('codec', 'feather'), ('mongodb_url', 'mongodb://localhost:27017')      \
  ],
  [
    ('backend', 'mongodb'), ('database_name', 'fastapi-cachette-database'), \
    ('codec', 'parquet'), ('mongodb_url', 'mongodb://localhost:27017')      \
  ],
  [
    ('backend', 'mongodb'), ('database_name', 'fastapi-cachette-database'), \
  ...
  ### Redis & Codecs ###
  [('backend', 'redis'), ('codec', 'csv'), ('redis_url', 'redis://localhost:6379')],     \
  [('backend', 'redis'), ('codec', 'feather'), ('redis_url', 'redis://localhost:6379')], \
  [('backend', 'redis'), ('codec', 'parquet'), ('redis_url', 'redis://localhost:6379')], \
  [('backend', 'redis'), ('codec', 'pickle'), ('redis_url', 'redis://localhost:6379')],  \
], ids=[
  'dynamodb-csv', 'dynamodb-feather', 'dynamodb-parquet', 'dynamodb-pickle',
  'inmemory-csv', 'inmemory-feather', 'inmemory-parquet', 'inmemory-pickle',
  'memcached-csv', 'memcached-feather', 'memcached-parquet', 'memcached-pickle',
